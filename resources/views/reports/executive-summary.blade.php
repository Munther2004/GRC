...
<body>
    ...
    @include('reports._partials._header', [
        'eyebrow'  => 'Confidential — For Executive Review Only',
        'title'    => 'Executive Summary — Security & Compliance Posture',
        'subtitle' => 'GRC Charter — Princess Sumaya University for Technology',
        'meta'     => 'Generated: ' . $generatedAt . '   •   AI-Assisted Narrative (claude-sonnet)',
    ])
        ...
        <table>
            ...
            <tbody>
                @foreach($topRisks as $i => $risk)
                    ...
                    @endphp
                    <tr>
                        <td style="color:#93939f; font-weight:bold;">{{ $i + 1 }}</td>
                        ...
                        <td style="text-align:center; color:#75758a; text-transform:capitalize;">{{ str_replace('_', ' ', $risk['status']) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
            ...
            <table>
                ...
                <tbody>
                    @foreach($nonCompliantCategories as $cat => $cnt)
                        <tr>
                            <td>{{ $cat }}</td>
                            <td style="text-align:center; font-weight:bold; color:#e5484d;">{{ $cnt }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
    ...
    @include('reports._partials._footer', [
        'left'  => 'Confidential — AI Executive Summary — GRC Charter',
