...
export const executiveDashboard = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: executiveDashboard.url(options),
    method: 'get',
})

executiveDashboard.definition = {
    methods: ["get","head"],
...
executiveDashboard.url = (options?: RouteQueryOptions) => {
    return executiveDashboard.definition.url + queryParams(options)
}
 ...
 */
    const executiveDashboardForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: executiveDashboard.url(options),
        method: 'get',
    })
 ...
 */
    ...
    executiveDashboard.form = executiveDashboardForm