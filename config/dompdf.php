...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var bool
         */
        // Enabled so the shared _page_chrome partial can write footer text + page numbers
        // via <script type="text/php"> page_script(). All template content is project-controlled
        // — no user-supplied HTML is ever passed to the PDF renderer.
        'enable_php' => true,
