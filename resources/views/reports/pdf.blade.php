...
<body>
    ...
    @include('reports._partials._footer', [
        'left'  => 'Confidential — Generated by GRC Charter',
        'right' => 'Princess Sumaya University for Technology — ' . $generatedAt,
    ])
